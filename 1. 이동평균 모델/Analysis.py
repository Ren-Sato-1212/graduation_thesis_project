...
def analysis(predict_file, answer_file, weeks_size):
    ...
    if weeks_size == 8:
        output_file = open('MA-Performance-80-8w.txt', 'w')
    elif weeks_size == 4:
        output_file = open('MA-Performance-80-4w.txt', 'w')
    else:
        output_file = open('MA-Performance-80-2w.txt', 'w')
